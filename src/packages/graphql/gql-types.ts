...
export type Artist = Item & {
  ...
  related_artists?: Maybe<RelatedArtists>;
  top_tracks?: Maybe<TopTracks>;
  type: ItemType;
  uri?: Maybe<Scalars['String']>;
};
...
export type ArtistResolvers<ContextType = any, ParentType extends ResolversParentTypes['Artist'] = ResolversParentTypes['Artist']> = {
  ...
  related_artists?: Resolver<Maybe<ResolversTypes['RelatedArtists']>, ParentType, ContextType>;
  top_tracks?: Resolver<Maybe<ResolversTypes['TopTracks']>, ParentType, ContextType, RequireFields<ArtistTop_TracksArgs, 'market'>>;
  type?: Resolver<ResolversTypes['ItemType'], ParentType, ContextType>;
  uri?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
